      ...
      <div className="bg-surface/50 border-b border-border">
        <div className="container py-12">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 mb-4 text-xs font-mono text-primary bg-primary/10 rounded-md border border-primary/20">
              ...
              <button
                ...
                className={`p-2 rounded-lg transition-colors ${
                  viewMode === 'grid' 
                    ...
                    : 'text-zinc-500 hover:text-white hover:bg-surface'
                }`}
              >
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-8">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full h-11 pl-11 pr-4 bg-surface border border-border rounded-xl text-sm font-mono text-white placeholder:text-zinc-500 focus:outline-none focus:border-primary/50 transition-colors"
            />
          </div>
            ...
            <button
              ...
              className={`px-4 py-2 text-sm font-medium rounded-lg transition-all ${
                selectedCategory === null
                  ? 'bg-primary/10 text-primary border border-primary/20'
                  : 'bg-surface text-zinc-400 border border-border hover:text-white hover:border-border-hover'
              }`}
            >
              All
            </button>
              ...
              <GlassCard key={tool.slug} hover padding="lg" className="group">
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-lg bg-surface border border-border-hover flex items-center justify-center text-lg font-bold text-white font-mono">
                      {tool.name[0]}
                    </div>
                    <div>
                ...
                <div className="flex gap-2 pt-4 border-t border-border">
                  ...
                  <a
                    ...
                    className="inline-flex items-center justify-center w-9 h-9 rounded-lg bg-surface border border-border-hover text-zinc-400 hover:text-primary hover:border-primary/20 transition-all"
          ...
          <div className="space-y-3 mb-8">
            {paginatedTools.map((tool) => (
              <GlassCard key={tool.slug} hover padding="md" className="group flex items-center gap-4">
                <div className="w-12 h-12 rounded-xl bg-surface border border-border-hover flex items-center justify-center text-xl font-bold text-white font-mono shrink-0">
                  {tool.name[0]}
                </div>
