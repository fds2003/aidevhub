---
title: "拾象实践：为了理解AI-Native，我们做了几款AI应用"
slug: "拾象实践-为了理解ai-native-我们做了几款ai应用"
description: "作者： 海外独角兽 来源： 海外独角兽 作者：秦佳豪 编辑：siqi 排版：Scout 本文来自拾象技术负责人秦佳豪对 LLM 应用实践的阶段性总结回顾。 2022 年底，拾象团队不仅从投资配置角度开始关注到 LLM 的趋势，在内部生产力实践中也亲身体会到 LLM 能力的强大，因而在内部进行了一系列 LLM 应用开发的实践，既包括对话式内部知识库、音视频转录这类..."
category: "ai-news"
tags: ["chatgpt", "AI", "AI聊天", "AI文本生成", "AI绘画", "AI编程", "AI电商"]
author: "AiBard123"
sourceUrl: "https://mp.weixin.qq.com/s/QCpGXsqYRzfHIPBiHAlsRw"
sourceName: "海外独角兽"
readingTime: "33 min"
createdAt: "2023-07-25T16:00:00.000Z"
publishedAt: "2023-07-25T16:00:00.000Z"
featured: false
---

作者： 海外独角兽  来源： [海外独角兽](https://mp.weixin.qq.com/s/QCpGXsqYRzfHIPBiHAlsRw)

![](https://mmbiz.qpic.cn/sz_mmbiz_gif/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOjlncv7iar5edEDlKWR2Gy273giaLxtdSGICQ1NWsp6YNMwBUgR37tT6Q/640?wx_fmt=gif)
![](https://mmbiz.qpic.cn/sz_mmbiz_png/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUO6gLlBic5mgaOWucMC0oK99xRLeOMZDJqpUVNdIoopp7xxYsQ7NKqJag/640?wx_fmt=png)
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOzkWpxcTPcIG33AFJ3sK2FEqibl6HTQeaXibk5lZLfiaWpUPVAaGb1zsCw/640?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOYgjickcZlB6Ih4rePtiaiclETJRQLlukMGeKlDLIayia2DBdb90cjgX8Ww/640?wx_fmt=png)

本文来自拾象技术负责人秦佳豪对 LLM 应用实践的阶段性总结回顾。

2022 年底，拾象团队不仅从投资配置角度开始关注到 LLM 的趋势，在内部生产力实践中也亲身体会到 LLM 能力的强大，因而在内部进行了一系列 LLM 应用开发的实践，既包括对话式内部知识库、音视频转录这类效率工具，也有复刻 GPT、LLM 输入法等偏实验性质尝试。随着模型能力的不断增强以及更多优质的探索框架的诞生，例如 OpenAI Function Calling、Code Interpreter、[AI agent](http://mp.weixin.qq.com/s?__biz=Mzg2OTY0MDk0NQ==&mid=2247502724&idx=1&sn=3d3eea620abbb46f09dc3b7440ac36be&chksm=ce9b741af9ecfd0c595c2dff9a1190affb8d015361c355e0fb9dc975eff63dff93aa12308d84&scene=21#wechat_redirect) 等，模型能力的提升迅速淹没了工程层面努力和创新。

虽然大部分实践在这个时间点看起来已经“过时”甚至“徒劳”，但快速了解一个行业的最佳的方式就是参与其中，尤其是 LLM 这样的新浪潮，也正是这一系列 hands-on 的经验也让我们有机会以第一视角观察这个领域。

今年 3 月，拾象开源了[《The Age of AI：拾象大模型及OpenAI投资思考》](http://mp.weixin.qq.com/s?__biz=Mzg2OTY0MDk0NQ==&mid=2247501241&idx=1&sn=aa2046e1cb75cb21b703805f294b6d5c&chksm=ce9b7a27f9ecf331863dc73ddc883373d18db3eaba2c847b0b147edd359f2b899942c62b4115&scene=21#wechat_redirect)，以 Top-Down 的视角分享了对大模型边界、格局、生态以及顶级玩家 OpenAI 的深度研究，本篇 LLM 应用探索笔记则是一位一线开发者对 LLM 的思考。

在这一系列 LLM 开发实践过程中，我们也形成了两款 LLM 应用，分别为 AI 跑团游戏《盗梦笔记》以及播客发现工具 PickPod，欢迎体验试用。如果您本人是产品开发者、并有兴趣和热情深度参与 LLM 应用的探索，也欢迎与我们联系。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOyNuXsk5icxcJYRPHykWFBTp12U9WB2Q4uUwdWt7ib2IMsFKv9cIEUIHQ/640?wx_fmt=jpeg)
*text-davinci-002 效果*
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOWPl0ZkV6bwaLkyZFSW7iaAlSHkrQjtJdtW3jQuqIejHhDfc6X3dkzpg/640?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOTrwAGG51cYSrz19iaC4yMCBSVFzTboomdOjsnamwOw9bddeBT53Y12w/640?wx_fmt=png)
*Source：OpenAI*
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOnQpMSkEiaGEgqaQ1rJEptI5SmicqKQwXU2pwFF5VGMgvKSuGSjRQCZ2w/640?wx_fmt=jpeg)
*Source：InstructGPT*
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUO4cuOkSCtLTDRib1Effw44syHagsIh2k9zpeEUSIvGdOlOes8zdn7JicQ/640?wx_fmt=png)
*原始的 GPT-2 中文模型*
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOuIQHI9XGd0u6TMIKJVgwB5o6Mr6wAu9m0on1lAAglOpaJRScQ6xXlw/640?wx_fmt=jpeg)
*Finetune 后和加入 PPO 后的差异*
![](https://mmbiz.qpic.cn/sz_mmbiz_png/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOzUboicZy6hT1l5Kz6Vk23yP1fvt6bib2fDCEKsSibGwKsrbT0BoQfEk0Q/640?wx_fmt=png)
*工程参考（链接详见reference）*
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOmJPMFukloPFMXUoBCUOyUuhtlUkibZ6yUOWtjAEMu5duFbExa3UCZPQ/640?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOubdDNPxllJfFyKFDMapuywsOmmSJvJEtAiaibfY6AK7Os0Fdub7k11zA/640?wx_fmt=jpeg)
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOsnnVTteogXI7js6xNxel3JWVBH6fJ3VtY1ibu77FYOZt4A7KtK1bicFQ/640?wx_fmt=jpeg)
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOVqfuZ7bsPt6icXVJVB4ADQNtkicun18PeWespnHOMoq56cibxS8TMtt8A/640?wx_fmt=jpeg)
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOLDKCicMDX2s0xaKAuR1f9OZN6wplSDZafzjPxibYVR4xWoJfoMdBaXTw/640?wx_fmt=jpeg)
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOkQapZbdZ3rl3gXjNMiaHtR2ssiaVVmfTDXicYxADlJeQk4ELnVWib5OkOA/640?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOKevUUBFuLt3dDia9BBG7o1grn32eY3qDgewq2KcTfjGnkI1ZoEygcvQ/640?wx_fmt=png)
*The Crowd 机器人实现路径*
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUO1dfs8uJp3lHqqhyHfeH3DX2nPYwiaOCeqPPCDuyq9ibXeFY9qkjNN8uw/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOECj414S20sDI5VJpt9ZYSwJKsjyvS5aofV7mgFTwrMSWrcU4WZe6Hg/640?wx_fmt=jpeg)
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOunft9FhzJB0XEXl6XpWojU9picnqKSxt1klrGYNHRUkZxl891EwjPXQ/640?wx_fmt=jpeg)
*一对 Airpods 只支持一个输入*
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOc4Ce3nej0iaw8zgp9hFfannvGcuwTkY80FK6jjO69ZTGo6QqEHTP9lg/640?wx_fmt=png)
*效果*
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOPf2Eic9WewsGVicB9Mova0fH8Jo8Y0CT2Rl2KQ3oyiaNlIdd3HfuC96Gw/640?wx_fmt=jpeg)
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOkBgvfQPaAlsiaMYD0avrNDEfmzhGNtKTicsibQYcXTrqH4siaBzL6z9FPA/640?wx_fmt=jpeg)

从技术层面，总结（Summary）、时间戳（Timestamp）以及章节提取（Chapters）的实现并不难，这些功能的 Prompt 都非常简单。以 Langchain 自带的 Summarize 为例，如下分别为单轮及多轮再聚合的处理方式：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOXNfPeibbDhLjcBLHz8E3ic5jpcOkEuUtgjfMAmI2mZoetia9Acn57hpdg/640?wx_fmt=png)
![](https://mmbiz.qpic.cn/sz_mmbiz_png/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOEcqpUzpBvHhxFiaPgbp7Zdco9X6icia4mQoe2emCzO0icvmkc0zaz9Af6Q/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOwA89C8zFRGUK3KPib5ZXUkHrMIkP5EVVYrncN0VSwJDJD3SQcicGml6A/640?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOrIYfXq6nbvPUP2Mia4SDFrICic82YRTlqqQRXZ0FWvZWQxiaLrMqSYs5g/640?wx_fmt=png)
![](https://mmbiz.qpic.cn/sz_mmbiz_png/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOchERJtVmg5RA7tq9dx6PaiaSeicIfB7AjgrchfwZLdwBXsRVm2kUhDhQ/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOJCqDJRicObkjHogvg9FNAykhK3Q2E5Ptd2deibfd2Q9ibaic5AogicWFMDQ/640?wx_fmt=jpeg)

****那对于我们个人而言，信息的增量最主要的来源其实是非共识** ，因为非共识的不确定性高，即信息熵高，尤其是针对个人的非共识，它是完全基于你有什么认知。**

再来举个实际例子，以**[《阶梯计划》** ](http://mp.weixin.qq.com/s?__biz=Mzg2OTY0MDk0NQ==&mid=2247499161&idx=1&sn=c52066dc51ba12c494f4f9923a477ba2&chksm=ce9b4207f9eccb11e36e9bd937a1a6977478894b538821f72bbc822203a57ecba725d383cf81&scene=21#wechat_redirect)的第五期节目为例。在 Summary 和时间戳的逻辑下，我们可以感受到这里有大量的信息量，但还是比较难决策为是否要听这一期内容：

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOx1iaL9u7GbrjicVUKGxEZKSHAJS788C2n2ibPpYwsJmicFxQJuhHjIVacQ/640?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUO65Eu5icHmmDOvII5uyfrVPrt0ptQPD8vAaW6Sl1ZnMx7IibZ0ypIlMxA/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOuqs92ItxYrk1EgHFmiaOMj7kWoAhrp8XONnMPFDEFQhrPN1I27hNw3A/640?wx_fmt=png)
*PickPod 产品逻辑*

我们用同样的方式对所有 OpenAI 相关的播客进行非共识观点的提取后，上面 George Hotz 播客的信息就变成了这样：

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUO6zN1XrfBZJb7APzgMcCQ4rgYEjWm8wzFeJdkCJex6GwP2BrSp10FUg/640?wx_fmt=jpeg)
*请点击放大查看详情*

💡

PickPod 的 Python 本地版本会进行开源，开源版本中包括了租云服务器及一键拉取环境配置的脚本和反馈迭代推荐系统的个人版本。（开源链接：https://github.com/shixiangcap/pickpod）
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUO7vdTIxaVNlHDuSBwlo5IKde1pXPR1EoqCFR8fBabEVWPickWtYknn9A/640?wx_fmt=jpeg)
*被“白嫖” API_key 时的后台异常访问*

**所以当时的一个感觉是，**基于 API 的项目如果要持续就必须找一个能有盈利的方式。****

如果按这个思路来看，游戏其实是一个非常好的载体：和工具类产品不同，游戏天然“离钱最近”，即便不依靠用户主动付费，通过引入广告，也能够达到收支平衡，并且和工具相比，游戏的用户沉浸时间要更多，极端情况下甚至可以在每轮都嵌入广告。于是就有了**《盗梦笔记》（内测入口）** 这款游戏的诞生。
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOMzWthOGnu3icj2lm42KiaK9fyWYXmh7reSFto2k8BZ87TbyUVFLhqibzg/640?wx_fmt=png)
*版本二游戏架构图示例（可放大阅读）*
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUO94ZCCqSWcicLaQlI1tiaNkL7vWnVbJmpDMCHo7ltYXucibbdn7vZiat6cw/640?wx_fmt=jpeg)
*OpenAI 的返回结果*
![](https://mmbiz.qpic.cn/sz_mmbiz_png/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUO5LUtjYDhhPblH4f8T9tVqbuxLJf2e3seKmB3Qm8ia3YB0r2h8UOEk5g/640?wx_fmt=png)
*Claude 返回结果*
...
在一些中间流程上，更强的大模型未必比小模型结合 sft 更好用，但如果需要中间状态有自己的推理能力，那现在 GPT4 还是远超其余模型；

- 

模型的“强”与“更强”取决于到底是谁在用：比如陶哲轩使用 ChatGPT 辅助自己的工作，那么 ChatGPT 接收到的问题质量就比其它模型高太多了，而这些智慧是 10 亿人的语料也换不来的；

- 

模型怎么更安全？这里的安全不只是 alignment 输出的内容足够安全、符合人类价值观，而是在信息接收和处理环节如何保障安全和隐私，否则真正科研人员是不敢用它作为助手；

- 

端测推理也是输入安全的很重要一部分，而不仅仅是更低成本实现 LLM 或者其它，目前开源模型的一些推理优化从效果来看也完全不输闭源产品的；

- 

如果要用 LLM 做应用感兴趣，搭建一定的基础服务能带来很多效率上的提升。过去的产品路径是产品经理已经有了输入输出的概念，开发人员保证输出符合即可；而现在多模型、多 agent 本质上对于结果的不确定性放大了很多，有可能边做边改比预先设定可能的效果更好，而这里的前提就是一定的基础服务。比如同样的查询能不能直接输出多 temperature 多模型的结果，这个结果又能不能直接被流程所记录甚至 AI 完成迭代。

- 

电子设备产品层面影响下一代才是关键。任何有意思的发明 都是先从影响下一代开始，最能接受、 LTV也最高，比如我 2 岁的女儿就喜欢和 pi 打电话，虽然和 pi 的交流完全不在一个频道，但并不影响她喜欢使用 pi 这件事。

- 

有观点认为近两年完全不用考虑 AI 应用，因为从目前 LLM 发展的速度和进展来看，可能更强的 AGI 确实能完全替代目前能力不足而要做的一些应用 tricks，但我个人相对乐观，一方面，做应用能一定程度上感受 LLM 的发展，另一方面，如果想要真正做 AGI，而不仅是非目前的客服替代流程加强，更需要应用从资金层面反哺做 LLM 的团队。
...
[https://github.com/HarderThenHarder/](https://github.com/HarderThenHarder/)

transformers_tasks

****2、LLM 输入法地址：****

[https://github.com/shixiangcap/llama-pinyinIME](https://github.com/shixiangcap/llama-pinyinIME)
...
[https://www.youtube.com/watch?v=K5iDUZPx60E&t=3030s](https://www.youtube.com/watch?v=K5iDUZPx60E&t=3030s)

****6、Pickpod开源链接：****

[https://github.com/shixiangcap/pickpod](https://github.com/shixiangcap/pickpod)

****7、李宏毅公开课-用ChatGPT玩文字冒险游戏 ：****

[https://www.youtube.com/watch?v=A6c584jxX8&list](https://www.youtube.com/watch?v=A6c584jxX8&list)

=PLJV_el3uVTsOePyfmkfivYZ7Rqr2nMk3W&index=4

****8、李宏毅公开课案例-用ChatGPT的常见误解：****

[https://www.youtube.com/watch?v=yiY4nPOzJEg](https://www.youtube.com/watch?v=yiY4nPOzJEg)

****9、版本二游戏架构图示例（可放大阅读）：****

[https://ibb.co/kqtYF57](https://ibb.co/kqtYF57)

****10、播客《AI+游戏：涌现、失控与灵魂付费》 ：****

[https://www.xiaoyuzhoufm.com/episode/](https://www.xiaoyuzhoufm.com/episode/)

6486811253a5e5ea1471b0b0

![](https://mmbiz.qpic.cn/sz_mmbiz_png/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOBIVNBNfXA0wvYSZTEeQ8PdylK1KVJKQNtDreeGun25WvKpCYyia5v8g/640?wx_fmt=png)
![](https://mmbiz.qpic.cn/sz_mmbiz_png/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOyON382bMA3w5wS54nSrlPxHq2ms7dicL9BP5YPjZCd5mmYeshItR5iag/640?wx_fmt=png)
![](https://mmbiz.qpic.cn/sz_mmbiz_png/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOIXibFV0ou2q8eBt7wLDCooSlLIkP8SthncJ5tFQI9OjZuUR7GHpCbJA/640?wx_fmt=png)

延伸阅读

![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOdibP77cXedJHcNLHwjtvov7F1U8XtKtnviaGMlzpJHzWP8icONCjKWECg/640?wx_fmt=jpeg)

Perplexity AI，比Google Bard和Bing Chat更靠谱的问答引擎

![](https://mmbiz.qpic.cn/sz_mmbiz_png/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOy8Lia5rse9c9zEx9064nSRXlWSGRSzOCicQIcm0Lodib9LRzO7P4cTSwQ/640?wx_fmt=png)
![](https://mmbiz.qpic.cn/sz_mmbiz_png/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOIEicDfuicRzXykqE1AUpoqiaL3h61rRFNGjMMGcgb2ZDI2jSaHTK7qAmg/640?wx_fmt=png)

OpenAI基金首批投资赛道，Kick是下一代ERP雏形？

![](https://mmbiz.qpic.cn/sz_mmbiz_png/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOy8Lia5rse9c9zEx9064nSRXlWSGRSzOCicQIcm0Lodib9LRzO7P4cTSwQ/640?wx_fmt=png)
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUO7acVeULAQ2TZOmYWdFnogj1OEneZS8EuHmmh0cVkOgx7BE8JqtvCXQ/640?wx_fmt=jpeg)

GPT-4 的“秘密”：MoE、参数量、训练成本和推理设计

![](https://mmbiz.qpic.cn/sz_mmbiz_png/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOy8Lia5rse9c9zEx9064nSRXlWSGRSzOCicQIcm0Lodib9LRzO7P4cTSwQ/640?wx_fmt=png)
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOVdRedeYkYRIAia8nNVl0ibgYl9oe2724lDvP8bGqTTILl4fI2lMLbL5g/640?wx_fmt=jpeg)

AI Agents大爆发：软件2.0雏形初现，OpenAI的下一步

![](https://mmbiz.qpic.cn/sz_mmbiz_png/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOy8Lia5rse9c9zEx9064nSRXlWSGRSzOCicQIcm0Lodib9LRzO7P4cTSwQ/640?wx_fmt=png)
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/3tHNibnJ2jgxicM38jxia7GwRtL3VdDQEUOvY5ZvQBzQjSoZAyXQA1d0tWic5lzv1uqUR1fUAFBkeuLKE7cEm7RVmg/640?wx_fmt=jpeg)
