---
title: "社区供稿OpenCSG解密代码生成模型StarCoderVSCodeLlama"
slug: "社区供稿opencsg解密代码生成模型starcodervscodellama"
description: "作者： Hugging Face 来源： Hugging Face 01 背景 2023年可以称之为大模型元年，也是AI模型在开源历史上最受关注的一年。各大企业、机构、高校纷纷发布了自研大模型，展示多年来AI能力的积累和从量变到质变的过程。大模型的出现突破了许多人对NLP、对AI算法的过往认识，越来越多的人开始相信大模型能够很好的理解人类自然语言并与人类交互，人工智能离..."
category: "ai-news"
tags: ["chatgpt", "AI", "AI聊天", "AI文本生成", "AI绘画", "AI编程", "AI电商"]
author: "AiBard123"
sourceUrl: "https://mp.weixin.qq.com/s/w_R5bZop1GaHLmTwS0SZsA"
...
作者： Hugging Face  来源： [Hugging Face](https://mp.weixin.qq.com/s/w_R5bZop1GaHLmTwS0SZsA)
...
StarCoder 和 StarCoderBase 的训练集来自于公开数据集 The Stack v1.2 ([https://huggingface.co/datasets/bigcode/the-stack](https://huggingface.co/datasets/bigcode/the-stack))，其中包含 6TB 的授权数据，覆盖358种编程语言。

StarCoder团队经过启发式过滤、人工检查筛选、清洗等处理之后还剩余 783GB 的代码数据，包含86种编程语言，其中有54GB的github issues数据和13GB jupyter notebook脚本和text-code数据对，32GB 的github commits数据，总计将近250B tokens。Bigcode组织秉承开源精神公开了清洗后的数据集——Starcoderdata ([https://huggingface.co/datasets/bigcode/starcoderdata](https://huggingface.co/datasets/bigcode/starcoderdata))。
...
在这部分我们会详细介绍StarCoder团队如何构造预训练数据的格式，其中**** 指的是特殊令牌 (special token)，**metadata** 和**data** 则是数据字段的占位符。

****代码****

代码部分的数据一共包含三个meta信息和代码正文 (code)，meta信息分别为存储库名称 (reponame)、文件名 (filename) 以及星级 (stars)，格式为****reponame****filename**<gh_stars>**stars**\n**code**<|endoftext|>******
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWzdScNfaWjIaCNf7ibA8ic617SQOQ9ENyo8QEyicunEwqkW8QM1v8hvDYA/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)

这部分数据被处理为以下格式：

**<issue_start>Title:**title**\nusername**_id0****:**comment0**<issue_comment>**username_id1:**comment1** … <issue_closed(optional)> <|endoftext|>**
...
这部分的数据结构与代码部分结构相同：reponamefilename<gh_stars>stars\ncode<|endoftext|>**
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmW8eIbGONXwpzJ9c51UHcsODZLfHXjWK6jYXMDQKJNogKcINHbvVBwrA/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWdn0GJeobBUKIpdj3eB3NIATCibr2Thnyiao4oYgicLzjq1GicZ6nUfPTibA/640?wx_fmt=jpeg&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWREfA3UDxodGaVmNvH9Uia29s7knkWWuQSl1XOTrmJ2CfN9H60RgP0Rw/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWKtfytaV4SVDEOfoZsOE6aTy6wWgULsWRSfqPJ7pjd9eWIuwbar1w9g/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWWTyt6vZ8ican9LMKM8CtMj66cWIv3lPIyA59hqLRXYY2KDr2Rkn1f1g/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmW0ricrk2DaVNPln2SIRjHZnh9ibxMhH9Ww7a0GiaSkSR6MErXJ6kCwxyZw/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWr9HnANA8KNwaN3IP8zzLf5kMl5twOiat0slcBYia0RpYHiacokTwBB6VA/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)

StarCoderBase 的性能明显优于其他两个规模较小的模型。

(2) Python 返回类型预测

![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWEF2Gial16GQYP1sKyMr2rGTwRZFTldht0rQwd36K1lxCjw2COB8ClYQ/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)

StarCoder 和 StarCoderBase 在 Python 返回类型预测方面优于其他模型。但是由于该评测集中的函数取自 GitHub 存储库，因此它们可能与 SantaCoder 和 StarCoder 模型的训练数据重叠。

(3) TypeScript 类型预测

![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWpSyQ5gB37eiaTWrecf2icPepUicZib6zZe6icENJOscibr4GegspdiaEyHb1A/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)

StarCoderBase 的表现优于 InCoder。

(4) Python Docstring 生成

![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWRwibwMhqEmicBpU8nmX8OrQFzz4ApiaGLU6ws7DF0A4BOUL9242ia7otSw/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWgNWbEfqlp25Fe5OTibQAaI4PuCIaWQtlibtFPZGlC5wke4BjqhtDlyxA/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWHjvHUojuKqibeicu0Mu5GMfUicatickjmzgXKTpE1farDSwFUemE1A381w/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWywDCrD9Cdr9XnxFibhplStd05mOblibO45qgqKcH6CBtHW34LDOvlXHg/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWzzIkicSFYElz9MKzPJedIcUbZECAxuAyIfCWicl4BvXeYcGJ1UWWUe7Q/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWdoYDKhSyJJAoTAJ2uwXUE1ypR1zkaAID1rCmU1MpDuOOeKdfcMLqJw/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWQpVzicbjDHYMHrcdQw0MTz85qNJ167Be3yuhFuR5iaH9RfUIde6wcI5w/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)

CodeLlama-13b-hf模型的生成结果：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWbbKA7bmgpVLhNMflOcwBsS2gBey8CsjVDs73ocYWPqiaCWZ10Er1bjg/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)

StarCoder模型的生成结果：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWJyC6iadQyAxHzbWXmhdJp3ggTXqicsDV66McEFoHeI2BkmvV4jWGAfrg/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWsibwrhvKCj2STkvd5TIV4kpic4iaJicyfNe7PwYCvwICiawXT733vJk9BqQ/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)

CodeLlama-13b-hf模型的生成结果：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWJibtfIicORCKJawo2ecnUQibzTlAg3cXWxYsVhMpLdTY17edr0ibXRSF4Q/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWqBZE9IPd5Ur35c3CZK0eQ077pnRrueRjFDeT4TzsKfZqibPgIKz9ibaw/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)

StarCoder模型的生成结果：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWeibZr6ic6lsJIicYcgIbCzWmyMNDpD21yGibuic2MdgOPMUZldiakynqIvBA/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWX187DlKiaHdNsSLaibtczlut9VhgiaIsgOH5ddWReJVBCJjd8gBiaxMULw/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)

CodeLlama-13b-hf模型的生成结果：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWb6AfU9Mjb1MmibxZrXym21T0on0uhicumKjxz2ZzmMcdZIM2S8HnrKog/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)

StarCoder模型的测试代码：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWuxyD38gyDJpicXjc8j0IzmbtK7wsDvS6qDzBSjc0jVopCBBdPpdKJcg/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)

StarCoder模型的生成结果：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWQuz5Er5vUI9yibSnTHZjENxS2Pv9XgGE1mW44KALuavTzmP2lQpicSMA/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWcoNYBvsBPWZ622Y0LibcQuzHQQSSKia615Ga9Dr0S4O9u9LtXoTfXvSw/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)

CodeLlama-13b-hf模型的生成结果：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWHFrq93mKIVq7aUT0NSp7GFqRYpDrGJjQbv00ibN0Rpia20PXMXMhicHcg/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)

StarCoder模型的生成结果：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWzwAydkdFcHLCzHqZgicDHY1AKFKDZFbPvTzVOvNUbblAjBPmkOAEr3w/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)

CodeLlama-13b-Python-hf模型的生成结果：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWeY37TR3kvkTNrKUOe5xibhndWEePYfsfGSkfF0UXH356N8TfEXias8BQ/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWYoCcicbEYPvhWIlC4ibl9ZIib2p7DUwxdeETWxjSczfLohuJByPTpUylw/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)

CodeLlama-13b-hf模型的生成结果：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWibZn6I5h4iaf4rjsiaz6vUcHV6zvYKGcqqP8yaC7vJMCNEIs8UX1sxzoQ/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)

StarCoder模型的生成结果：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWktFE2Nhficgvibpiaze9DeYAdBhwrN70X2GEOzc5P7wIb7x4ptTV9yicIw/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)

CodeLlama-13b-Python-hf模型的生成结果：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmW0yJbr9fO1MbmrDnDY86e5BegQwNI8vV36ibV0dIJrOKNlC23TqTgNaw/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWGZwJXdNicibxTth2KnN6hXAInEaibHVPFNibveqFWlwGcAxDh6KrxwCoMw/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)

CodeLlama-13b-hf模型的生成结果：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWCWLzx5oocXKORzpUYMJLs5QiaHaUicZict1Is2G2ibfJ8H9yfhJYN6hv1w/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)

StarCoder模型的生成结果：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWQWV8YvVduSxic28cbZ8XM9fCCgzFkFwK2Zm3nKtThB0qS0PSkwgTbGw/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)

CodeLlama-13b-Python-hf模型的生成结果：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWhrmye2QUH6WuDOs4JR9bef5MCn2lP8AARlT3CzhsEbDDNaGUDUdEYQ/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/ZC2neNoyG74KjZjAWE44cIpC4XkEXBmWbotJrY41gfVEib2n6WIOJQsTUj1TKQSgNq9zQYGiaAunRfbticibphicZIA/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&wx_co=1)
...
huggingface社区：[https://hf.co/opencsg](https://hf.co/opencsg)**

OpenCSG社区：[https://www.opencsg.com/](https://www.opencsg.com/)**

Github社区：[https://github.com/OpenCSGs](https://github.com/OpenCSGs)**

****参考链接****

1.StarCoder: 最先进的代码大模型

[https://huggingface.co/blog/zh/StarCoder](https://huggingface.co/blog/zh/StarCoder)

2.StarCoder: A State-of-the-Art LLM for Code

[https://huggingface.co/blog/StarCoder](https://huggingface.co/blog/StarCoder)

3.Creating a Coding Assistant with StarCoder

[https://huggingface.co/blog/starchat-alpha](https://huggingface.co/blog/starchat-alpha)

4.使用StarCoder创建一个编程助手

[https://huggingface.co/blog/zh/starchat-alpha](https://huggingface.co/blog/zh/starchat-alpha)

5.StarCoder Memorization Experiment Highlights Privacy Risks of Fine-Tuning On Code

[https://huggingface.co/blog/dhuynh95/StarCoder-memorization-experiment](https://huggingface.co/blog/dhuynh95/StarCoder-memorization-experiment)
