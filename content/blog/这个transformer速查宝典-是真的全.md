---
title: "这个Transformer速查宝典，是真的全！"
slug: "这个transformer速查宝典-是真的全"
description: "作者： DASOU 来源： DASOU 各位好，我是DASOU； 大模型如火如荼，最近国外有个网友最近写了一个关于Transformer 的综述文章(注: kipply’s blog)，质量还挺高的。建议大家收藏阅读一下。 这个综述涵盖了 21 种Trm架构大模型、11 种架构变化、7 种预训练后处理技术和 3 种训练技术（还有 5 种不属于以上技术的东西） 。 模型..."
category: "ai-news"
tags: ["chatgpt", "AI", "AI聊天", "AI文本生成", "AI绘画", "AI编程", "AI电商"]
author: "AiBard123"
sourceUrl: "https://mp.weixin.qq.com/s/Xv3ToptwFmSlw8nEfj7P9w"
sourceName: "DASOU"
readingTime: "19 min"
...
作者： DASOU  来源： [DASOU](https://mp.weixin.qq.com/s/Xv3ToptwFmSlw8nEfj7P9w)

![](https://mmbiz.qpic.cn/sz_mmbiz_png/LU88NSfAnCxGjIhnWpTYiasBLBZIDQiadSYT0ycu8mETbEN0urIEv9QBjedobTVbNOrUvXeyJza77Ca1OLHViak6A/640?wx_fmt=png)

各位好，我是DASOU；

大模型如火如荼，最近国外有个网友最近写了一个关于Transformer 的综述文章(注: kipply’s blog)，质量还挺高的。建议大家收藏阅读一下。

****这个综述涵盖了 21 种Trm架构大模型、11 种架构变化、7 种预训练后处理技术和 3 种训练技术（还有 5 种不属于以上技术的东西）** 。**

模型包括 GPT-3、GPT-4、Gopher、AlphaCode、RETRO、GPT-3.5、Chinchilla、Flamingo 等。一些重要的架构变化包括多查询注意力、稀疏注意力、混合专家等。同时还介绍了 RLHF、CAI、Minerva 等预训练后处理技术以及超参。
...
它在一个 300B token 的数据集上进行训练。该数据集主要由过滤后的 Common Crawl 以及一些书籍、网络文本构成；
...
它使用 SentencePiece 进行分词，词汇表大小为 32k，并用 300B token 进行训练，其中一半来自为 Gopher 收集的 MassiveText，以及书籍、Common Crawl、新闻和 Github。
